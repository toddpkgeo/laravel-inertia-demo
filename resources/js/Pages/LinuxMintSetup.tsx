          ...
          <div className="relative w-full max-w-2xl px-6 py-4 lg:max-w-7xl">
            ...
            <main>
              <article className="prose prose-neutral prose-ul:list-square dark:prose-invert">
                ...
                <p>
                  These are my notes from when I installed Linux Mint 22 on my
                  laptop.
                </p>
                <H2>Why Mint?</H2>
                <p>
                  This is for a laptop that I could take with me to new
                  environments. I'd rather not troubleshoot WiFi, printing,
                  remote file systems, etc., which could possibly waste another
                  person's time.
                </p>
                <p className="mt-3">
                  Mint handles the kinds of setup that are especially boring to
                  me. Printing is unusually painless with this distro. It also
                  ships without Ubuntu Snaps, which I'd rather not try to remove
                  from any other Ubuntu distro.
                </p>
                <p className="mt-3">
                  That only applies to laptops, though. For Workstations and
                  VMs, I'd rather build up my OS from a minimal base.
                </p>
                ...
                <ul className="mt-3 list-disc">
                  ...
                  <ul className="ml-3 list-disc">
                    ...
                    <ul className="ml-4 list-disc">
                      ...
                      <li>
                        <Code>/swap</Code>, but this could be a separate option
                        (file or partition, how big)
                      </li>
                    </ul>
                ...
                <ul className="list-disc">
                  ...
                  <ul className="ml-3 list-disc">
                    ...
                    <li>
                      A good list of other exclusions apply by default. Click
                      Filter - Summary to view.
                    </li>
                  </ul>
                  <li>
                  ...
                  <ul className="ml-3 list-disc">
                    <li>
                      normally I expect CLI password prompts to not echo
                      anything
                    </li>
                    <li>
                  ...
                  <ul className="ml-3 list-disc">
                    ...
                    <li>
                      Software Sources - Mirrors and wait for some speed
                      measurements to finish
                    </li>
                    <li>Set Caps to Escape in Keyboard - Layout</li>
                    <li>I Changed move/resize key from Alt to Super</li>
                  </ul>
                  <li>
                    Confirm that printing just works by joining a new network
                    with a printer
                  </li>
                  <ul className="ml-3 list-disc">
                  ...
                  <ul className="ml-3 list-disc">
                    ...
                    <li>
                      I make other <Code>ssh-*</Code> aliases for these
                      connections
                    </li>
                    ...
                    <ul className="ml-4 list-disc">
                      <li>
                        <Code>
                          ssh-keygen -t rsa -C "for XYZ server" -f
                          ~/.ssh/xyz_rsa
                        </Code>
                      </li>
                      <li>A strong RSA variant will be used by default</li>
                    </ul>
                    <li>
                      Copy public keys with <Code>ssh-copy-id</Code>
                    </li>
                    <li>
                    ...
                    <ul className="ml-4 list-disc">
                      ...
                      <li>
                        Think of this as a keyring with many keys, and some
                        "locks" only offer a couple of tries.
                      </li>
                      <li>
                        Try using <Code>ssh -i $key</Code> or{" "}
                        <Code>scp -i $key</Code>, which doesn't require the
                        agent.
                      </li>
                      <li>
                        I do still want SSH Agent for Git Repo (Bitbucket, Azure
                        Repo) keys
                      </li>
                      <li>
                        unless there's a way to configure git to use a specific
                        key and not the agent
                      </li>
                      <li>
                        So to keep the "keyring" small, I only add keys for
                        remote repos
                      </li>
                      <li>
                        On Ubuntu, any `.ssh/$x` with a corresponding
                        `.ssh/$x.pub` file will be auto-added to the keyring
                      </li>
                      <li>
                        ...
                        and replace "id_rsa" with whatever space-separated keys
                        you need.
                      </li>
                    </ul>
                    <li>
