          ...
          <div className="relative w-full max-w-2xl py-4 px-6 lg:max-w-7xl">
            ...
            <main>
              ...
              <p>
                ...
                environments. I'd rather not troubleshoot WiFi, printing, remote
                file systems, etc., which could possibly waste another person's
                time.
              </p>
              <p className="mt-3">
              ...
              <p className="mt-3">
                That only applies to laptops, though. For Workstations and VMs,
                I'd rather build up my OS from a minimal base.
              </p>
                ...
                <ul className="list-disc ml-3">
                  ...
                  <ul className="list-disc ml-4">
                    ...
                    <li>
                      ...
                      <Code>scp -i $key</Code>, which doesn't require the agent.
                    </li>
                    <li>
                    ...
                    <li>
                      So to keep the "keyring" small, I only add keys for remote
                      repos
                    </li>
                    <li>
