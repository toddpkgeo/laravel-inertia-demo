      ...
      <article className="prose prose-neutral prose-ul:list-square">
        ...
        <ul className="list-disc mt-3">
          ...
          <ul className="list-disc ml-3">
            ...
            <ul className="list-disc ml-4">
              <li>
                <Code>/home</Code>,<Code>/.snapshots</Code>,<Code>/mnt</Code>,
                <Code>/run</Code>,<Code>/tmp</Code>,<Code>/var</Code>
              </li>
              <li>
                <Code>/swap</Code>, but this could be a separate option (file or
                partition, how big)
              </li>
            </ul>
            ...
            <ul className="list-disc ml-4">
              ...
              <li>
                More subvols creates more granularity when choosing what to
                snapshot
              </li>
            </ul>
          </ul>
        ...
        <ul className="list-disc">
          ...
          <ul className="list-disc ml-3">
            ...
            <li>
              A good list of other exclusions apply by default. Click Filter -
              Summary to view.
            </li>
          </ul>
          <li>
            Verify that <Code>fstrim.timer</Code> is running, which is good for
            SSD longevity
          </li>
          <ul className="list-disc ml-3">
            <li>
          ...
          <ul className="list-disc ml-3">
            <li>normally I expect CLI password prompts to not echo anything</li>
            <li>
          ...
          <ul className="list-disc ml-3">
            <li>Scrolling on Title bar can be set to adjust window opacity</li>
            <li>
              Software Sources - Mirrors and wait for some speed measurements to
              finish
            </li>
          ...
          <li>
            Confirm that printing just works by joining a new network with a
            printer
          </li>
          <ul className="list-disc ml-3">
          ...
          <ul className="list-disc ml-3">
            <li>
              I make an <Code>ssh-list</Code> alias to remind me of connections
              that I might want to use
            </li>
            <li>
              I make other <Code>ssh-*</Code> aliases for these connections
            </li>
            ...
            <li>
              <em>ASIDE</em>: Avoid SSH Agent if using more than a few keys
            </li>
            <ul className="list-disc ml-4">
              <li>Too many keys can lead to a "too many attempts" error.</li>
              <li>
                Think of this as a keyring with many keys, and some "locks" only
                offer a couple of tries.
              </li>
              <li>
                Try using <Code>ssh -i $key</Code> or <Code>scp -i $key</Code>,
                which doesn't require the agent.
              </li>
              <li>
                I do still want SSH Agent for Git Repo (Bitbucket, Azure Repo)
                keys
              </li>
              <li>
                unless there's a way to configure git to use a specific key and
                not the agent
              </li>
              <li>
              ...
              <li>
                On Ubuntu, any `.ssh/$x` with a corresponding `.ssh/$x.pub` file
              ...
              <li>
                ...
                and replace "id_rsa" with whatever space-separated keys you
                need.
              </li>
            </ul>
            <li>Verify that SSH login works and password login doesn't</li>
          </ul>
        </ul>
      </article>
    </GuestLayout>
